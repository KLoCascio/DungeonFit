...
export default function Character() {
  ...
  return (
    <div className='Character'>
      ...
      <button onClick={toggleInventory} className='inventory-button'>
        INVENTORY
      </button>
      <button onClick={toggleQuests} className='quests-button'>
        QUESTS
      </button>
      <button onClick={toggleAbilities} className='abilities-button'>
        ABILITIES
      </button>
